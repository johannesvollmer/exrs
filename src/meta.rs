...
use crate::{
    ...
    error::{i32_to_usize, usize_to_i32, Error, Result, UnitResult},
...
pub mod magic_number {
    use super::{Data, Error, Read, Result, UnitResult, Write};
...
pub mod sequence_end {
    use super::{Data, PeekRead, Read, Result, UnitResult, Write};
...
pub fn compute_chunk_count(
    ...
    if let BlockDescription::Tiles(tiles) = blocks {
        ...
        use crate::meta::attribute::LevelMode::{MipMap, RipMap, Singular};
...
mod test {
    ...
    use crate::meta::{
        attribute::{
            AttributeValue, ChannelDescription, ChannelList, IntegerBounds, LineOrder, SampleType,
            Text,
        },
