...
/// Zigzag order for 8x8 DCT coefficients
/// Maps linear index to zigzag-ordered index
/// This ordering places low-frequency coefficients first,
/// improving RLE compression efficiency
