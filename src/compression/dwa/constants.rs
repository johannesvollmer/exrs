...
pub const QUANT_TABLE_Y: [f32; BLOCK_AREA] = [
    1.6, 1.1, 1.0, 1.1, 1.4, 1.6, 2.3, 3.0, 1.1, 1.2, 1.2, 1.4, 1.6, 2.3, 3.0, 3.4, 1.0, 1.2, 1.5,
    1.6, 2.3, 3.0, 3.4, 3.0, 1.1, 1.4, 1.6, 2.3, 3.0, 3.4, 3.0, 2.5, 1.4, 1.6, 2.3, 3.0, 3.4, 3.0,
    2.5, 2.1, 1.6, 2.3, 3.0, 3.4, 3.0, 2.5, 2.1, 1.7, 2.3, 3.0, 3.4, 3.0, 2.5, 2.1, 1.7, 1.5, 3.0,
    3.4, 3.0, 2.5, 2.1, 1.7, 1.5, 1.3,
];
...
pub const QUANT_TABLE_CBCR: [f32; BLOCK_AREA] = [
    1.0, 1.0, 1.0, 2.0, 3.5, 3.5, 3.5, 3.5, 1.0, 1.0, 1.2, 2.6, 3.5, 3.5, 3.5, 3.5, 1.0, 1.2, 2.2,
    3.5, 3.5, 3.5, 3.5, 3.5, 2.0, 2.6, 3.5, 3.5, 3.5, 3.5, 3.5, 3.5, 3.5, 3.5, 3.5, 3.5, 3.5, 3.5,
