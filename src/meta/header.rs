...
use crate::{
    ...
    meta::{
        ...
        CompressedBlock, Error, Headers, PeekRead, Read, Requirements, Result, RoundingMode,
        SmallVec, TileCoordinates, TileIndices, TryFrom, UnitResult, Write,
    },
};
...
impl Header {
    ...
    // self.absolute_block_pixel_coordinates(tile.location).expect("tile coordinate
    // bug");
    //
    // BlockIndex {
    // layer: layer_index,
